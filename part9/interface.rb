  ...
  def show_trains_on_the_station
    ...
    station.each_train do |train|
      ...
      train.each_wagon do |wagon|
        ...
        if wagon.instance_of? PassengerWagon
          puts "Wagon №: #{wagon.number},occupied seats #{wagon.occupy}, free seats: #{wagon.free_volume},
                wagon type: #{wagon.class}"
        end
        if wagon.instance_of? CargoWagon
          puts "Wagon №: #{wagon.number},occupied space #{wagon.occupy}, free space: #{wagon.free_volume},
               wagon type: #{wagon.class}"
        end
      end
    end
